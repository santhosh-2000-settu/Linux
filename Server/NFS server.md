...
- \# yum install nfs-utils
  ...
  ![](media/image1.tmp){width="6.0in" height="0.7506944444444444in"}

Check the rpcbind service status:

- \# systemctl status rpcbind.service

  ![](media/image2.tmp){width="6.0in" height="2.1645833333333333in"}
...
![](media/image3.tmp){width="6.0in" height="2.6534722222222222in"}

Check the SELinux status:

- \# sestatus

  ![](media/image4.tmp){width="4.11132217847769in"
...
- \# systemctl enable \--now nfs-server.service
  ...
  ![](media/image5.tmp){width="6.0in" height="0.22083333333333333in"}
...
- \# mkdir /sharedata
  ...
  ![](media/image6.tmp){width="3.00709864391951in"
...
- /data client-IP(rw,sync,no_root_squash)
  ...
  ![](media/image7.tmp){width="5.375276684164479in"
...
- \# exportfs -rav
  ...
  ![](media/image8.tmp){width="6.0in" height="0.5340277777777778in"}

- \# exportfs -v

  ![](media/image9.tmp){width="6.0in" height="0.3736111111111111in"}
...
- \# showmount -e
  ...
  ![](media/image10.tmp){width="3.7640824584426946in"
...
- \# getenforce
  ...
  ![](media/image11.tmp){width="4.986367016622922in"
...
- \# yum install nfs-utils
  ...
  ![](media/image12.tmp){width="6.0in" height="2.057638888888889in"}

### 2. Check Available Exports

- \# showmount -e server_IP

  ![](media/image13.tmp){width="3.7571380139982504in"
...
- \# mkdir /dir_name
  ...
  ![](media/image14.tmp){width="2.465404636920385in"
...
- \# mount server_IP:/dir_name(server) /dir_name(client)
  ...
  ![](media/image15.tmp){width="4.458562992125985in"
...
- \# df -h
  ...
  ![](media/image16.tmp){width="6.0in" height="1.3458333333333334in"}
...
![](media/image17.tmp){width="2.6876377952755908in"
height="0.7222594050743657in"}

Same file should appear in server

![](media/image18.tmp){width="2.1251093613298337in"
...
![](media/image19.tmp){width="5.944749562554681in"
height="5.000256999125109in"}

You cant create a file in client mechine

![](media/image20.tmp){width="3.7571380139982504in"
